...
#     PROFESSOR_ID = models.ForeignKey('professors', to_field = 'PROFESSOR_ID', on_delete =models.CASCADE, related_name="scenarios1", default = 1)
...
#     PAGE_ID = models.AutoField(primary_key = True, editable=False)
#     PAGE_CHOICES = (
#         ('R', 'REFLECTION'),
#         ('S', 'STAKEHOLDERS'),
#         ('A', 'ACTION'),
...
#     STAKEHOLDER_ID = models.AutoField(primary_key = True, editable = False)
#     NAME = models.CharField(max_length = 1000, default = "default")
#     DESC = models.TextField(default = "default")
#     MAIN_CONVERSATION = models.TextField(default = "default")
#     SCENARIO_ID = models.ForeignKey('scenarios', to_field = 'SCENARIO_ID', on_delete = models.CASCADE, related_name="stakeholders2", default = 1)
#     VERSION_ID = models.ForeignKey('scenarios', on_delete = models.CASCADE, related_name="stakeholders3", default = 1)
#     # def __str__(self):
#     #     return self.NAME
...
#     class Meta:
#         unique_together = (('STAKEHOLDER_ID'), ('CONVERSATION_ID'))
#     STAKEHOLDER_ID = models.ForeignKey('stakeholders', on_delete = models.CASCADE, related_name="conversations1", default=7)
#     CONVERSATION_ID = models.AutoField(default = None, primary_key = True)
...
#     class Meta:
#         unique_together = (('SCENARIO_ID'),('ISSUE_ID'),('VERSION_ID'))
#     SCENARIO_ID = models.ForeignKey('scenarios', on_delete = models.CASCADE, related_name = "scenario_id5", default = None)
#     ISSUE_ID = models.AutoField(default = None, primary_key = True, editable = False)
#     VERSION_ID = models.ForeignKey('scenarios',on_delete = models.CASCADE, related_name = "version_id5", default = None)
#     NAME = models.CharField(max_length = 1000)
...
#     class Meta:
#         unique_together = (('STAKEHOLDER_ID'),('ISSUE_ID'),('VERSION_ID'))
#     STAKEHOLDER_ID = models.ForeignKey('stakeholders', on_delete = models.CASCADE, related_name = "coverage2", default = None)
#     ISSUE_ID = models.ForeignKey('Issues', on_delete = models.CASCADE, related_name = "coverage1", default = None)
...
class coverage(models.Model):
    ...
    # VERSION_ID = models.ForeignKey('stakeholders',on_delete = models.CASCADE, related_name = "coverage3", default = 1)
    COVERAGE_SCORE = models.FloatField(validators = [MinValueValidator(0.0)])
