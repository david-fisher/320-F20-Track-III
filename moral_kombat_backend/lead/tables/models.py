...
class pages(models.Model):
    ...
    SCENARIO = models.ForeignKey('scenarios', to_field = 'SCENARIO', on_delete = models.CASCADE, related_name="pages1")
    VERSION = models.ForeignKey('scenarios', to_field = 'VERSION', on_delete = models.CASCADE, related_name="pages2")
...
class stakeholders(models.Model):
    ...
    VERSION = models.ForeignKey('scenarios', on_delete = models.CASCADE, to_field = 'VERSION', related_name="stakeholders3", default = 1)
...
class responses(models.Model):
    ...
    VERSION = models.ForeignKey('scenarios', to_field = 'VERSION', on_delete = models.CASCADE, related_name="responses3")
...
class reflections_taken(models.Model):
    ...
    SCENARIO = models.ForeignKey('scenarios', to_field = 'SCENARIO', on_delete = models.CASCADE, related_name="reflections_taken3")
    VERSION = models.ForeignKey('scenarios', to_field = 'VERSION', on_delete = models.CASCADE, related_name="reflections_taken4")
...
class scenarios_for(models.Model):
    ...
    SCENARIO = models.ForeignKey('scenarios', to_field = 'SCENARIO', on_delete = models.CASCADE, related_name="scenarios_for1")
...
class Issues(models.Model):
    ...
    SCENARIO = models.ForeignKey('scenarios', to_field = 'SCENARIO', on_delete = models.CASCADE, related_name = "scenario_id5", default = None)
...
class assigned_to(models.Model):
    ...
    SCENARIO = models.ForeignKey('scenarios', to_field = 'SCENARIO', on_delete = models.CASCADE, related_name="assigned_to2")
...
class student_times(models.Model):
    ...
    SCENARIO = models.ForeignKey('scenarios', to_field = 'SCENARIO', on_delete = models.CASCADE, related_name="student_times2")
    VERSION = models.ForeignKey('scenarios',on_delete = models.CASCADE, to_field = 'VERSION', related_name = "student_times3")
