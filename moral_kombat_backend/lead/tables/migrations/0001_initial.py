    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('VERSION', models.IntegerField(default=1, editable=False)),
                ('NAME', models.CharField(default='deafult', max_length=1000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('NEXT_PAGE', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='pages3', to='tables.pages')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('STAKEHOLDER', models.ForeignKey(default=3, on_delete=django.db.models.deletion.CASCADE, related_name='conversations1', to='tables.stakeholders')),
            ],
            options={
