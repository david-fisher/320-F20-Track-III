# Generated by Django 3.1.1 on 2020-11-16 16:26
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='courses',
            fields=[
                ('COURSE', models.IntegerField(editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('PROFESSOR', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='scenarios1', to='tables.professors')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('VERSION', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='stakeholders3', to='tables.scenarios')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('VERSION', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='responses3', to='tables.scenarios')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('NEXT_PAGE', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='pages3', to='tables.pages')),
                ('SCENARIO', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pages1', to='tables.scenarios')),
                ('VERSION', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pages2', to='tables.scenarios')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('VERSION', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='version_id5', to='tables.scenarios')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('SCENARIO', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='conversations_had3', to='tables.responses')),
                ...
                ('STUDENT', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='conversations_had1', to='tables.responses')),
                ('VERSION', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='conversations_had4', to='tables.scenarios')),
            ],
        ),
        migrations.CreateModel(
            name='students_in',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('VERSION', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='student_times3', to='tables.scenarios')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('VERSION', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='scenarios_for3', to='tables.scenarios')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('SCENARIO', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reflections_taken3', to='tables.responses')),
                ('STUDENT', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reflections_taken1', to='tables.responses')),
                ('VERSION', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reflections_taken4', to='tables.scenarios')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('VERSION', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assigned_to3', to='tables.scenarios')),
            ],
            options={
