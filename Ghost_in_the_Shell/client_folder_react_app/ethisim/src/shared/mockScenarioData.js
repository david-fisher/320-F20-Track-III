...
const mockComponentsFlowChart = {
  scenarioId: 2,
  components: [
    {id: '1', type: 'Event',  title: 'Simulation Introduction', position: { x: 0, y: 0 }},
    {id: '2', type: 'Reflection',  title: 'Initial Reflection', position: { x: 0, y: 0 }},
    ...
    {id: '10', type: 'Event', title: 'Consequences', position: { x: 0, y: 0 }},
  ],
}

export { mockUnfinishedScenarioData, mockFinishedScenarioData, mockComponentsFlowChart }