    ...
    <div id="parent">
      ...
      <form id="DeleteButton">
        <Button
          variant="contained"
          color="primary"
          onClick={() => props.removeStakeHolder(props.stakeHolder.id)}
        >
          Delete
        </Button>
      </form>
      ...
      />
        ...
        <DialogActions>
          <Button autoFocus onClick={handleCloseTwo} color="primary">
            Save changes
          </Button>
        </DialogActions>
        </div>
      ...
      >
         <div style= {{width: 900}}>
        <DialogTitle id="customized-dialog-title" onClose={handleCloseFour}>
          <h2>Questions</h2>
        ...
        <DialogActions>
          <Button autoFocus onClick={handleCloseFour} color="primary">
            Save changes
          </Button>
        </DialogActions>
        </div>
