...
import { Typography, Button, Avatar, Grid, TextField } from '@material-ui/core';
...
export default function StakeHolderListNode({ id, name }) {
    ...
    StakeHolderListNode.propTypes.id = { id };
    StakeHolderListNode.propTypes.name = { name };
    ...
    return (
        <Grid container direction="row" justify="flex-start">
            ...
            <Grid className={classes.informationSide} item xs={9}>
                ...
                />
                <Typography variant="h6">Conversation Entry:</Typography>
                <SunEditor
                    setOptions={{
                        width: '100%',
                        height: 300,
